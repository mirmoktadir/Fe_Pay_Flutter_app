...
class ExchangeAddScreen extends StatefulWidget {
  static const String id = 'ExchangeAddScreen';

  @override
  _ExchangeAddScreenState createState() => _ExchangeAddScreenState();
}

class _ExchangeAddScreenState extends State<ExchangeAddScreen> {
  String tac;
  String dkk;
  @override
        ...
        child: Column(
          children: [
            ...
            SizedBox(
              ...
              child: TextButton(
                onPressed: () {
                  Navigator.pushNamed(context, ExchangeAddScreen2.id);
                },
                child: Center(
                  child: Text(
                    'ADD',
