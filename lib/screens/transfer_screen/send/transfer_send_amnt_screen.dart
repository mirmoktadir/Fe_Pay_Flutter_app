...
class TransferSendAmntScreen extends StatefulWidget {
  static const String id = 'TransferSendAmntScreen';

  @override
  _TransferSendAmntScreenState createState() => _TransferSendAmntScreenState();
}

class _TransferSendAmntScreenState extends State<TransferSendAmntScreen> {
  String tac;
  String emailNo;
