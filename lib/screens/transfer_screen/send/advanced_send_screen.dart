...
class AdvancedSendScreen extends StatefulWidget {
  static const String id = 'AdvancedSendScreen';

  @override
  _AdvancedSendScreenState createState() => _AdvancedSendScreenState();
}

class _AdvancedSendScreenState extends State<AdvancedSendScreen> {
  String tac;
  String emailNo;
  bool _value = false;
  createAlert6Dialog(BuildContext context) {
    return showDialog(
          ...
          return AlertDialog(
            ...
            content: Column(
              ...
              children: [
                Center(
                  child: Text(
                    'TAC 50 sent to contact@gmail.com',
                    style: TextStyle(
                    ...
                    Flexible(
                      child: SizedBox(
                        ...
                        child: TextButton(
                          onPressed: () {
                            Navigator.pushNamed(
                                context, TransferSendStatusScreen.id);
                            createAlert6Dialog(context);
                          },
                          child: Center(
                            child: Text(
                              'Send',
                      ...
                      Row(
                        children: [
                          ...
                          Container(
                            ...
                            child: Text(
                              'Would you like to send anonymously?',
                              style: TextStyle(
                                fontSize: 14,
                                fontWeight: FontWeight.w400,
                                fontFamily: 'Roboto',
